...
$$u_i(s^*_1,\ldots, s^*_{i-1}, s^*_i, s^*_{i+1}, \ldots, s^*_n) \geq u_i(s^*_1,\ldots, s^*_{i-1}, s_i, s^*_{i+1}, \ldots, s^*_n) \,\, \mbox{para todo} \,\, s_i \,\, \mbox{de} \,\, S_i $$
...
$$\mbox{max} \, u_i(s^*_1,\ldots, s^*_{i-1}, s_i, s^*_{i+1}, \ldots, s^*_n) \,\, \mbox{donde} \,\, s_i \,\, \mbox{es la variable de decisión y pertenece a} \,\, S_i$$
