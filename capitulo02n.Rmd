...
Los juegos estáticos (o simultaneos) se representan normalmente en **forma normal** G que consta de tres elementos $$G = (N,S,u)$$ donde,
  ...
  - 2.  $S = S_1$ x $S_2$ x ... x $S_n$ describe las acciones factibles de los jugadores. Los juagdores eligen simultaneamente una estrategia $s = (s_1, \ldots, s_n) \in S$. Se obtienen los resultados
