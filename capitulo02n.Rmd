...
Atendiendo el número de jugadores se distinguen juegos **bipersonales**, si participan dos jugadores, y juegos **n-personales**, cuando participan más de dos.

### Juegos finitos e infinitos
Atendiendo al número de alternativas que posee cada jugador, señalaremos los juegos finitos, cuando éstas son un número finito e infinitos, en otro caso.
...
### Forma normal
Los juegos estáticos (o simultaneos) se representan normalmente en **forma normal** G \cite{UC3MGameTheory2020Ch1} que consta de tres elementos $$G = (N,S,u)$$ donde,

  - 1.  $N = \{1, \ldots, n\}$ es el conjunto de tomadores de decisiones, es decir, los jugadores
...
### Forma extensiva
Los juegos dinámicos (o secuencales) se representan en **forma extensiva** \cite{Gibbons1992} tienen una estructura similar a la de los juegos en forma normal. Es decir, también constan de un conjunto de jugadores, sus conjuntos de estrategias y sus pagos. Se especifica:
...
\begin{tcolorbox}[colback=blue!10] 
\textbf{Ejemplo 2 \cite{UC3MGameTheory2020Ch2}} \\
