...
### Forma normal
Los juegos estáticos se representan en **forma normal** G que consta de tres elementos $$G = (N,S,u)$$ donde,
...
### Forma extensiva
Los juegos dinámicos se representan en **forma extensiva** tienen una estructura similar a la de los juegos en forma normal. Es decir, también constan de un conjunto de jugadores, sus conjuntos de estrategias y sus pagos. Se especifica:
