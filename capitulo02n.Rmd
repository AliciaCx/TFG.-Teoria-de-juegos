...
### Notación general de un juego
Un juego puede definirse mediante:
...
### Forma normal
Los juegos estáticos se representan en **forma normal**, es decir, un juego con $n$ jugadores especifica los espacios de estrategias de los jugadores $S_1, \ldots, S_n$ y sus funciones de ganancia $u_1, \ldots, u_n$. Denotamos este juego con G = $\{S_1, \ldots, S_n;u_1, \ldots, u_n\}$. 
